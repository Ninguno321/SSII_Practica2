...
\begin{enumerate}
    ...
    \item \textbf{Explicación breve de cómo se representa el conocimiento incierto mediante Factores de Certeza.}
        Segun la medida de la creencia y de la incredulidad, si una es maxima, la otra es 0, no se pueden dar a la vez, son complementarias.

    \item \textbf{¿Qué es lo que mide un factor de certeza FC asociado a un hecho A?}
        La creencia con la que creemos o dejamos de creer una hipótesis
